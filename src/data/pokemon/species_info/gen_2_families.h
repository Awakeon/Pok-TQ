...
const struct SpeciesInfo gSpeciesInfoGen2[] =
{
    ...
    [SPECIES_CHIKORITA] =
    {
        ...
        .abilities = { ABILITY_SOOTHING_AROMA, ABILITY_LEAF_GUARD, ABILITY_GRASSY_SURGE },
    ...
    [SPECIES_TOTODILE] =
    {
        ...
        .abilities = { ABILITY_TORRENT, ABILITY_ROUGH_SKIN, ABILITY_STRONG_JAW },
    ...
    [SPECIES_FERALIGATR] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_MONSTER, EGG_GROUP_WATER_1),
        .abilities = { ABILITY_INTIMIDATE, ABILITY_ROUGH_SKIN, ABILITY_STRONG_JAW },
        .bodyColor = BODY_COLOR_BLUE,
    ...
    [SPECIES_LEDYBA] =
    {
        ...
        .abilities = { ABILITY_VICTORY_STAR, ABILITY_EARLY_BIRD, ABILITY_AERILATE },
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 26, SPECIES_LEDIAN}),
    },
    ...
    [SPECIES_LEDIAN] =
    {
        ...
        .growthRate = GROWTH_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_BUG),
        .abilities = { ABILITY_JUSTIFIED, ABILITY_VICTORY_STAR, ABILITY_PIXILATE },
        .bodyColor = BODY_COLOR_RED,
...
#define TOGEPI_FAMILY_TYPE (P_UPDATED_TYPES >= GEN_6 ? TYPE_FAIRY : TYPE_NORMAL)
    ...
    [SPECIES_MAREEP] =
    {
        ...
        .abilities = { ABILITY_STATIC, ABILITY_ILLUMINATE, ABILITY_FLUFFY },
        .bodyColor = BODY_COLOR_WHITE,
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 24, SPECIES_FLAAFFY}),
    },
    ...
    [SPECIES_FLAAFFY] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 44, SPECIES_AMPHAROS}),
    },
...
#define UNOWN_MISC_INFO(letter, _noFlip, frontWidth, frontHeight, backWidth, backHeight, backYOffset)   \
    ...
    [SPECIES_SNEASEL] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_SNIPER, ABILITY_KEEN_EYE, ABILITY_TECHNICIAN },
        .bodyColor = BODY_COLOR_BLACK,
        .noFlip = TRUE,
    ...
    [SPECIES_WEAVILE] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_SNIPER, ABILITY_KEEN_EYE, ABILITY_REFRIGERATE },
        .bodyColor = BODY_COLOR_BLACK,
    ...
    [SPECIES_SLUGMA] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_AMORPHOUS),
        .abilities = { ABILITY_MAGMA_ARMOR, ABILITY_DESOLATE_LAND, ABILITY_WEAK_ARMOR },
        .bodyColor = BODY_COLOR_RED,
...
#define CORSOLA_DEFENSES (P_UPDATED_STATS >= GEN_7 ? 95 : 85)
    ...
    [SPECIES_CELEBI] =
    {
        ...
        .baseSpAttack  = 100,
        .baseSpDefense = 100,
        .types = MON_TYPES(TYPE_AURA, TYPE_GRASS),
        .catchRate = 45,
    #if P_UPDATED_EXP_YIELDS >= GEN_8
        .expYield = 300,
    #elif P_UPDATED_EXP_YIELDS >= GEN_5
