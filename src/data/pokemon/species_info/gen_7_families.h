...
const struct SpeciesInfo gSpeciesInfoGen7[] =
{
    ...
    [SPECIES_GRUBBIN] =
    {
        ...
        .abilities = { ABILITY_STRONG_JAW, ABILITY_EARTH_EATER, ABILITY_VOLT_ABSORB },
    ...
    [SPECIES_CHARJABUG] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_BUG),
        .abilities = { ABILITY_BATTERY, ABILITY_SHELL_ARMOR, ABILITY_VOLT_ABSORB },
    ...
    [SPECIES_VIKAVOLT] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_BUG),
        .abilities = { ABILITY_STRONG_JAW, ABILITY_TRANSISTOR, ABILITY_LEVITATE },
        .bodyColor = BODY_COLOR_BLUE,
    ...
    [SPECIES_CRABOMINABLE] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_WATER_3),
        .abilities = { ABILITY_THERMAL_EXCHANGE, ABILITY_FUR_COAT, ABILITY_ANGER_SHELL },
    ...
    [SPECIES_SALAZZLE] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_MONSTER, EGG_GROUP_DRAGON),
        .abilities = { ABILITY_CORROSION, ABILITY_POISON_PUPPETEER, ABILITY_OBLIVIOUS },
        .bodyColor = BODY_COLOR_BLACK,
    ...
    [SPECIES_ORANGURU] =
    {
        ...
        .baseSpAttack  = 90,
        .baseSpDefense = 110,
        .types = MON_TYPES(TYPE_NORMAL, TYPE_AURA),
        .catchRate = 45,
        .expYield = 172,
        .evYield_SpDefense = 2,
        .genderRatio = PERCENT_FEMALE(50),
    ...
    [SPECIES_GOLISOPOD] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_BUG, EGG_GROUP_WATER_3),
        .abilities = { ABILITY_EMERGENCY_EXIT, ABILITY_BATTLE_ARMOR, ABILITY_NONE },
        .bodyColor = BODY_COLOR_GRAY,
...
#define SILVALLY_SPECIES_INFO(type, _palette)                                       \
    ...
    [SPECIES_SILVALLY_PSYCHIC]  = SILVALLY_SPECIES_INFO(TYPE_AURA,  Psychic),
...
#define MINIOR_CORE_SPECIES_INFO(Form, color, iconPal)          \
    ...
    [SPECIES_COSMOG] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
        .abilities = { ABILITY_UNAWARE, ABILITY_NEUTRALIZING_GAS, ABILITY_WIMP_OUT },
        .bodyColor = BODY_COLOR_BLUE,
    ...
    [SPECIES_COSMOEM] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL_DAY, 73, SPECIES_SOLGALEO},
                                {EVO_LEVEL_NIGHT, 73, SPECIES_LUNALA}),
    },
    ...
    [SPECIES_SOLGALEO] =
    {
        ...
        .baseSpAttack  = 113,
        .baseSpDefense = 89,
        .types = MON_TYPES(TYPE_AURA, TYPE_STEEL),
        .catchRate = 45,
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
        .abilities = { ABILITY_FULL_METAL_BODY, ABILITY_ILLUMINATE, ABILITY_NONE },
        .bodyColor = BODY_COLOR_WHITE,
    ...
    [SPECIES_LUNALA] =
    {
        ...
        .baseSpAttack  = 137,
        .baseSpDefense = 107,
        .types = MON_TYPES(TYPE_AURA, TYPE_GHOST),
        .catchRate = 45,
        .expYield = (P_UPDATED_EXP_YIELDS >= GEN_8) ? 340 : 306,
        .evYield_SpAttack = 3,
        .genderRatio = MON_GENDERLESS,
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
        .abilities = { ABILITY_SHADOW_SHIELD, ABILITY_ILLUMINATE, ABILITY_NONE },
        .bodyColor = BODY_COLOR_PURPLE,
    ...
    [SPECIES_NIHILEGO] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
        .abilities = { ABILITY_BEAST_BOOST, ABILITY_CORROSION, ABILITY_NONE },
        .bodyColor = BODY_COLOR_WHITE,
    ...
    [SPECIES_BUZZWOLE] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
        .abilities = { ABILITY_BEAST_BOOST, ABILITY_GUTS, ABILITY_NONE },
        .bodyColor = BODY_COLOR_RED,
    ...
    [SPECIES_XURKITREE] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
        .abilities = { ABILITY_BEAST_BOOST, ABILITY_ILLUMINATE, ABILITY_NONE },
        .bodyColor = BODY_COLOR_BLACK,
    ...
    [SPECIES_KARTANA] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
        .abilities = { ABILITY_BEAST_BOOST, ABILITY_SHARPNESS, ABILITY_NONE },
        .bodyColor = BODY_COLOR_WHITE,
    ...
    [SPECIES_GUZZLORD] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
        .abilities = { ABILITY_BEAST_BOOST, ABILITY_GLUTTONY, ABILITY_NONE },
        .bodyColor = BODY_COLOR_BLACK,
    ...
    [SPECIES_NECROZMA_ULTRA] =
    {
        ...
        .baseSpAttack  = 167,
        .baseSpDefense = 97,
        .types = MON_TYPES(TYPE_AURA, TYPE_DRAGON),
        .catchRate = 255,
