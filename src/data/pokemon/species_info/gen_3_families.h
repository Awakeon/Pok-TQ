...
const struct SpeciesInfo gSpeciesInfoGen3[] =
{
    ...
    [SPECIES_GROVYLE] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_MONSTER, EGG_GROUP_DRAGON),
        .abilities = { ABILITY_LEAF_GAURD, ABILITY_SHARPNESS, ABILITY_UNBURDEN },
        .bodyColor = BODY_COLOR_GREEN,
    ...
    [SPECIES_SCEPTILE] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_MONSTER, EGG_GROUP_DRAGON),
        .abilities = { ABILITY_LEAF_GUARD, ABILITY_SHARPNESS, ABILITY_UNBURDEN },
        .bodyColor = BODY_COLOR_GREEN,
...
#define RALTS_FAMILY_TYPE2 (P_UPDATED_TYPES >= GEN_6 ? TYPE_FAIRY : TYPE_PSYCHIC)
    ...
    [SPECIES_SEVIPER] =
    {
        ...
        .abilities = { ABILITY_SHARPNESS, ABILITY_GOOD_AS_GOLD, ABILITY_NONE},
        .bodyColor = BODY_COLOR_BLACK,
        .noFlip = TRUE,
