...
const struct SpeciesInfo gSpeciesInfoGen3[] =
{
    ...
    [SPECIES_TREECKO] =
    {
        ...
        .abilities = { ABILITY_OVERGROW, ABILITY_PROTOSYNTHESIS, ABILITY_INNER_FOCUS },
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 20, SPECIES_GROVYLE}),
    },
    ...
    [SPECIES_GROVYLE] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_MONSTER, EGG_GROUP_DRAGON),
        .abilities = { ABILITY_SHARPNESS, ABILITY_PROTOSYNTHESIS, ABILITY_INNER_FOCUS },
        .bodyColor = BODY_COLOR_GREEN,
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 40, SPECIES_SCEPTILE}),
    },
    ...
    [SPECIES_LOMBRE] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_WATER_1, EGG_GROUP_GRASS),
        .abilities = { ABILITY_SWIFT_SWIM, ABILITY_PRANKSTER, ABILITY_OWN_TEMPO },
        .bodyColor = BODY_COLOR_GREEN,
    ...
    [SPECIES_SEEDOT] =
    {
        ...
        .abilities = { ABILITY_CHLOROPHYLL, ABILITY_EARLY_BIRD, ABILITY_BATTLE_ARMOR },
        .bodyColor = BODY_COLOR_BROWN,
    ...
    [SPECIES_NUZLEAF] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD, EGG_GROUP_GRASS),
        .abilities = { ABILITY_CHLOROPHYLL, ABILITY_PRANKSTER, ABILITY_PUNK_ROCK },
        .bodyColor = BODY_COLOR_BROWN,
    ...
    [SPECIES_SHIFTRY] =
    {
        ...
        .abilities = { ABILITY_CHLOROPHYLL, ABILITY_WIND_RIDER, ABILITY_INTIMIDATE },
    #else
...
#if P_FAMILY_RALTS
#define RALTS_FAMILY_TYPE2 (P_UPDATED_TYPES >= GEN_6 ? TYPE_FAIRY : TYPE_AURA)
    ...
    [SPECIES_RALTS] =
    {
        ...
        .baseSpAttack  = 75,
        .baseSpDefense = 60,
        .types = MON_TYPES(TYPE_AURA, RALTS_FAMILY_TYPE2),
        .catchRate = 235,
    ...
    [SPECIES_PROBOPASS] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_MINERAL),
        .abilities = { ABILITY_STURDY, ABILITY_MAGNET_PULL, ABILITY_MINI_NOSES },
        .bodyColor = BODY_COLOR_GRAY,
    ...
    [SPECIES_CAMERUPT] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
    #if P_UPDATED_ABILITIES >= GEN_4
        .abilities = { ABILITY_MAGMA_ARMOR, ABILITY_OWN_TEMPO, ABILITY_ANGER_POINT },
    #else
    ...
    [SPECIES_SPOINK] =
    {
        ...
        .baseSpAttack  = 70,
        .baseSpDefense = 80,
        .types = MON_TYPES(TYPE_AURA, TYPE_ROCK),
        .catchRate = 255,
    ...
    [SPECIES_TRAPINCH] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_BUG),
    #endif
        .abilities = { ABILITY_HYPER_CUTTER, ABILITY_ARENA_TRAP, ABILITY_STRONG_JAW },
        .bodyColor = BODY_COLOR_BROWN,
    ...
    [SPECIES_ZANGOOSE] =
    {
        ...
        .growthRate = GROWTH_ERRATIC,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_TOXIC_BOOST, ABILITY_IMMUNITY, ABILITY_TOUGH_CLAWS },
        .bodyColor = BODY_COLOR_WHITE,
        .noFlip = TRUE,
    ...
    [SPECIES_SEVIPER] =
    {
        ...
        .abilities = { ABILITY_SHARPNESS, ABILITY_SHED_SKIN, ABILITY_NONE},
        .bodyColor = BODY_COLOR_BLACK,
        .noFlip = TRUE,
    ...
    [SPECIES_LUNATONE] =
    {
        ...
        .baseSpAttack  = 95,
        .baseSpDefense = 85,
        .types = MON_TYPES(TYPE_ROCK, TYPE_AURA),
        .catchRate = 45,
    #if P_UPDATED_EXP_YIELDS >= GEN_7
        .expYield = 161,
    #elif P_UPDATED_EXP_YIELDS >= GEN_5
    ...
    [SPECIES_BALTOY] =
    {
        ...
        .baseSpAttack  = 40,
        .baseSpDefense = 70,
        .types = MON_TYPES(TYPE_GROUND, TYPE_AURA),
        .catchRate = 255,
    ...
    [SPECIES_ABSOL] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
    #if P_UPDATED_ABILITIES >= GEN_4
        .abilities = { ABILITY_SHARPNESS, ABILITY_SUPER_LUCK, ABILITY_DARK_AURA },
    #else
    ...
    [SPECIES_BELDUM] =
    {
        ...
        .baseSpAttack  = 35,
        .baseSpDefense = 60,
        .types = MON_TYPES(TYPE_STEEL, TYPE_AURA),
        .catchRate = 3,
    ...
    [SPECIES_METAGROSS] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_MINERAL),
        .abilities = { ABILITY_CLEAR_BODY, ABILITY_CPU_COOLING, ABILITY_LIGHT_METAL },
        .bodyColor = BODY_COLOR_BLUE,
    ...
    [SPECIES_LATIAS] =
    {
        ...
        .baseSpAttack  = 110,
        .baseSpDefense = 130,
        .types = MON_TYPES(TYPE_DRAGON, TYPE_AURA),
        .catchRate = 3,
    #if P_UPDATED_EXP_YIELDS >= GEN_8
        .expYield = 300,
    #elif P_UPDATED_EXP_YIELDS >= GEN_5
