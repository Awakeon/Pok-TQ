...
const struct SpeciesInfo gSpeciesInfoGen9[] =
{
    ...
    [SPECIES_GARGANACL] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_MINERAL),
        .abilities = { ABILITY_PURIFYING_SALT, ABILITY_WATER_ABSORB, ABILITY_CLEAR_BODY },
        .bodyColor = BODY_COLOR_BROWN,
    ...
    [SPECIES_RABSCA] =
    {
        ...
        .baseSpAttack  = 115,
        .baseSpDefense = 100,
        .types = MON_TYPES(TYPE_BUG, TYPE_AURA),
        .catchRate = 45,
        .expYield = 165,
        .evYield_SpAttack = 2,
        .genderRatio = PERCENT_FEMALE(50),
    ...
    [SPECIES_ORTHWORM] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_EARTH_EATER, ABILITY_SAND_FORCE, ABILITY_NONE},
        .bodyColor = BODY_COLOR_PINK,
    ...
    [SPECIES_GREAVARD] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_SAND_RUSH, ABILITY_FLASH_FIRE, ABILITY_FLUFFY },
        .bodyColor = BODY_COLOR_WHITE,
    ...
    [SPECIES_HOUNDSTONE] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_SAND_RUSH, ABILITY_EARLY_BIRD, ABILITY_FLUFFY },
        .bodyColor = BODY_COLOR_WHITE,
    ...
    [SPECIES_SCREAM_TAIL] =
    {
        ...
        .baseSpAttack  = 65,
        .baseSpDefense = 115,
        .types = MON_TYPES(TYPE_FAIRY, TYPE_AURA),
        .catchRate = 50,
        .expYield = 285,
        .evYield_HP = 3,
        .itemRare = ITEM_BOOSTER_ENERGY,
