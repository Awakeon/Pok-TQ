...
const struct MoveInfo gMovesInfo[MOVES_COUNT_ALL] =
{
    ...
    [MOVE_TWINEEDLE] =
    {
        ...
        .description = COMPOUND_STRING(
            "Jabs the foe twice with\n"
            "stringers. Each hit 50% chance to poison"),
        .effect = EFFECT_HIT,
        .power = 35,
        .type = TYPE_BUG,
        .accuracy = 100,
    ...
    [MOVE_DISABLE] =
    {
        ...
        .description = COMPOUND_STRING(
            "Psychically stops the foe\n"
            "from attacking. Can only be used 1st turn on field."),
        #if B_UPDATED_MOVE_DATA >= GEN_5
            .accuracy = 100,
        #elif B_UPDATED_MOVE_DATA == GEN_4
            .accuracy = 80,
    ...
    [MOVE_HYPER_BEAM] =
    {
        ...
        .description = COMPOUND_STRING(
            "Fires an extremely powerful\n"
            "beam that sharply lowers\n"
            "the user's Sp.Atk"),
        .effect = EFFECT_HIT,
        .power = 130,
        .type = TYPE_NORMAL,
    ...
    [MOVE_PECK] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "jabbing beak, etc. Hits 2-5 times."),
        .effect = EFFECT_HIT,
        .power = 25,
        .type = TYPE_FLYING,
        .accuracy = 100,
    ...
    [MOVE_SOLAR_BEAM] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "then attacks next turn. Fires instantly in Sun."),
    ...
    [MOVE_POISON_POWDER] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "to poison the foe. Hits both targets in doubles."),
    ...
    [MOVE_THUNDER] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "cause paralysis. 100% accuracy in rain."),
    ...
    [MOVE_DOUBLE_TEAM] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "dodge attacks. Protects the user."),
    ...
    [MOVE_BUBBLE] =
    {
        ...
        .effect = EFFECT_HIT,
        .power = B_UPDATED_MOVE_DATA >= GEN_6 ? 55 : 20,
        .type = TYPE_WATER,
        .accuracy = 100,
        .pp = 30,
        .target = MOVE_TARGET_BOTH,
    ...
    [MOVE_SPLASH] =
    {
        ...
        .description = COMPOUND_STRING(
            "It's just a splash...\n"
            "Hits both opponents in doubles."),
    ...
    [MOVE_SUNNY_DAY] =
    {
        ...
        .contestComboMoves = {0},
        .battleAnimScript = gBattleAnimMove_Full_Moon,
        .validApprenticeMove = TRUE,
    },
    ...
    [MOVE_FRENZY_PLANT] =
    {
        ...
        .description = COMPOUND_STRING(
            "Strikes the foe with deadly"
            "vines. Can't be used 2x in a row"),
        .effect = EFFECT_HIT,
        .power = 140,
        .type = TYPE_GRASS,
        .accuracy = 100,
    ...
    [MOVE_X_SCISSOR] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "Blades. High critical-hit ratio "),
        .effect = EFFECT_HIT,
        .power = 80,
        .type = TYPE_BUG,
        .accuracy = 100,
    ...
    [MOVE_DRAGON_PULSE] =
    {
        ...
        .description = COMPOUND_STRING(
            "Creates a wave to\n"
            "damage the foe, 20% chance to lower Sp. Def."),
        .effect = EFFECT_HIT,
    ...
    [MOVE_ENERGY_BALL] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "attack. 30% chance to lower Sp.Def."),
        .effect = EFFECT_HIT,
    ...
    [MOVE_GIGA_IMPACT] =
    {
        ...
        .description = COMPOUND_STRING(
            "An extremly powerful tackle\n"
            "that sharply lowers users Attack."),
        .effect = EFFECT_HIT,
        .power = 130,
        .type = TYPE_NORMAL,
        .accuracy = 90,
    ...
    [MOVE_BEHEMOTH_BASH] =
    {
        ...
        .description = COMPOUND_STRING(
            "Attacks as a shield. +1 "
            "Priortiy. Changes Aegislash to shield forme."),
        .effect = EFFECT_HIT,
        .power = 100,
        .type = TYPE_STEEL,
        .accuracy = 100,
    ...
    [MOVE_G_MAX_WILDFIRE] =
    {
        .name = COMPOUND_STRING("Max Wildfire"),
        .description = sNullDescription,
        .effect = EFFECT_HIT,
        .power = 120,
        .type = TYPE_FIRE,
